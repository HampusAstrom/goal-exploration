...
from stable_baselines3.common.policies import BasePolicy, ContinuousCritic, ICM
...
class SACwithICM(SAC):
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        ent_coef_losses, ent_coefs = [], []
        actor_losses, critic_losses, icm_fw_losses, icm_iv_losses = [], [], [], []
        ...
        for gradient_step in range(gradient_steps):
            ...
            # append losses for backwards etc
